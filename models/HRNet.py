...
class HRNet(nn.Module):
    ...
    def forward(self, lrs, alphas, get_fea=False):
        '''
        ...
        '''
        #alphas = torch.tensor([1 for i in range(lrs.shape[1])]).to(device='cuda')
        batch_size, seq_len, c, heigth, width = lrs.shape
        #lrs = (lrs+1)/2

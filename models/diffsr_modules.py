...
class Unet(nn.Module):
    def __init__(self, dim, out_dim=None, dim_mults=(1, 2, 4, 8), cond_dim=32):
        ...
        elif hparams["use_ltae"]|hparams["use_highresnet"]:
            self.cond_proj = nn.ConvTranspose2d(64,
                                                dim, hparams['sr_scale'] * 2, hparams['sr_scale'],
                                                hparams['sr_scale'] // 2)
        elif hparams["use_rrdb_ltae"]:
            self.cond_proj = nn.ConvTranspose2d(32,
                                                dim, hparams['sr_scale'] * 2, hparams['sr_scale'],
                                                hparams['sr_scale'] // 2)
        else :
            self.cond_proj = nn.ConvTranspose2d(cond_dim * 3,
                                                dim, hparams['sr_scale'] * 2, hparams['sr_scale'],
                                                hparams['sr_scale'] // 2)
    ...
    def forward(self, x, time, cond, img_lr_up):
        ...
        elif hparams['use_ltae'] | hparams['use_highresnet']|hparams["use_rrdb_ltae"]:

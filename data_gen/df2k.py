...
import sys
sys.path.insert(1, '/home/aimi/Documents/code/tests/SRDiff-1.0.0/')
...
def build_bin_dataset(paths, binary_data_dir, prefix, patch_size, crop_size, thresh_size):
    ...
    builder = IndexedDatasetBuilder(f'{binary_data_dir}/{prefix}', True)
...
if __name__ == '__main__':
    ...
    #test_img_list = sorted(glob.glob('data/raw/ORT_2018/test/*.jp2'))
    test_img_list = sorted(glob.glob('data/raw/ORT_2018/300x300/*.jp2'))
